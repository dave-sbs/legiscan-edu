 ...
 * 
 * Just copied all the content directly. Need to dive deeper.
 */
...
function SubmitButton() {
  ...
  return (
    <button
      className="absolute bottom-3 right-3 bg-green-600 p-2 text-white rounded-lg outline-green-600 outline-offset-2 focus-visible:outline-2 focus-visible:outline transition disabled:opacity-70"
      disabled={pending}
    >
      {pending ? (
        <svg
